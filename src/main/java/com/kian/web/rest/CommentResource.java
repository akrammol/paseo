...
import com.kian.service.CommentService;
...
/**
 * REST controller for managing {@link com.kian.domain.Comment}.
 */
@RestController
@RequestMapping("/api")
public class CommentResource {
    ...
    private static final String ENTITY_NAME = "paseoComment";
     ...
     */
    @GetMapping("/comments")
    public ResponseEntity<List<CommentDTO>> getAllComments(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
