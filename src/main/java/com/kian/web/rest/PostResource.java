...
import com.kian.service.PostService;
...
/**
 * REST controller for managing {@link com.kian.domain.Post}.
 */
@RestController
@RequestMapping("/api")
public class PostResource {
    ...
    private static final String ENTITY_NAME = "paseoPost";
     ...
     */
    @GetMapping("/posts")
    public ResponseEntity<List<PostDTO>> getAllPosts(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
